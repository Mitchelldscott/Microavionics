...
Initial:
    ...
    CLRF PORTD, A
    MOVLF 0x03h, TRISD, A ; Set TRISD so RDO & ((PORTD) and 0FFh), 1, a are input
  ...
  ; Turn ON ((PORTD) and 0FFh), 5, a
  ; call subroutine to wait 1 second
  ; Turn OFF ((PORTD) and 0FFh), 5, a
  ; Turn ON ((PORTD) and 0FFh), 6, a
  ; call subroutine to wait 1 second
  ; Turn OFF ((PORTD) and 0FFh), 6, a
  ; Turn ON ((PORTD) and 0FFh), 7, a
  ; call subroutine to wait 1 second
  ; Turn OFF ((PORTD) and 0FFh), 7, a
