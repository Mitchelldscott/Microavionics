...
SOURCEFILES_QUOTED_IF_SPACED=src/lab3_orig.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/lab3_orig.o
POSSIBLE_DEPFILES=${OBJECTDIR}/src/lab3_orig.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/lab3_orig.o

# Source Files
SOURCEFILES=src/lab3_orig.asm
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/src/lab3_orig.o: src/lab3_orig.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/lab3_orig.o 
	${MP_AS} -mcpu=PIC18F87K22 -c \
	-o ${OBJECTDIR}/src/lab3_orig.o \
	src/lab3_orig.asm \
...
dist/${CND_CONF}/${IMAGE_TYPE}/Lab3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o dist/${CND_CONF}/${IMAGE_TYPE}/Lab3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
