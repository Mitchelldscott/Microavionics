# 1 "../Lab4/src/scott-mitchell-lab4.asm"
# 1 "<built-in>" 1
# 1 "../Lab4/src/scott-mitchell-lab4.asm" 2
...
Initial:
    ...
    CLRF PORTE, A
    MOVLF 0x08h, TRISE, A ; set input for ((PORTE) and 0FFh), 3, a
    ...
    MOVLF 0x40h, PORTE, A ; turn off ((PORTD) and 0FFh), 5, a and turn on ((PORTD) and 0FFh), 6, a
    RCALL Wait1sec ; Pause for 1 second
